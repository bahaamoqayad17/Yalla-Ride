    ...
    <div className="min-h-screen text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          {/* Book Now Button */}
          <Button className="bg-[#0136FB] hover:bg-[#0136FB]/80 px-8 py-5 text-lg rounded-lg font-semibold">
            Book Now!
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-42">
          ...
          <div>
            ...
            {/* Next Step Button */}
            <Button className="w-full bg-[#0136FB] hover:bg-[#0136FB]/80 py-8 text-2xl rounded-lg font-semibold mb-4">
              Next Step
            </Button>
