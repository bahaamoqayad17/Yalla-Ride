    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <div className="flex items-center justify-center w-6 h-6">
          <Plus className="text-muted-foreground pointer-events-none size-4 shrink-0 transition-all duration-200 [&[data-state=open]]:hidden" />
          <Minus className="text-muted-foreground pointer-events-none size-4 shrink-0 transition-all duration-200 hidden [&[data-state=open]]:block" />
        </div>
      </AccordionPrimitive.Trigger>
